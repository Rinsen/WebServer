...
namespace DemoWeb
{
    public class FormPostController : Controller
    {
        // Example with form collection

        public void Index()
        {
            SetHtmlResult("<!DOCTYPE html><html><body><h1>My Form example page</h1><p>Type your name.</p><form action=\"/FormPost/Data\" method=\"post\"> First name: <input type=\"text\" name=\"firstname\"><br> Last name: <input type=\"text\" name=\"lastname\"><input type=\"submit\" value=\"Submit\"></form> </body></html>");
        }
